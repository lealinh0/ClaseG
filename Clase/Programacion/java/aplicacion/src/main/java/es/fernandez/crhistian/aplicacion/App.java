...
public class App extends Application {
    ...
    getBundle("es/fernandez/crhistian/aplicacion/textos_es_ES");
    ...
    public void start(Stage stage) throws IOException {
        ...
        try{
            if (!bd.conecta().isEmpty()) {
                gestor.mostrarAlertError("ERROR BD",App.textos.getString("No_se_pudo_conectar"));
                Platform.exit();
                System.exit(0);
            }
    ...
    private static Parent loadFXML(String fxml) throws IOException {
        ...
        = new FXMLLoader(App.class.getResource(fxml + ".fxml"),textos);
        return fxmlLoader.load();

        
//        FXMLLoader fxmlLoader = new FXMLLoader(App.class.getResource(fxml + ".fxml"), textos);
//        return fxmlLoader.load();
    }
